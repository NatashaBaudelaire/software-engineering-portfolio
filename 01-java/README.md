...
This directory contains Java programming exercises covering fundamental programming concepts and object-oriented programming principles. These exercises were completed as part of my learning journey in Java development.
...
- **minutesandseconds**: Time unit conversions
- **odometer**: Odometer reading calculations
- **reversesentence**: Sentence reversal
- **ticketsales**: Ticket sales tracking
- **ticketssold**: Tickets sold statistics
...
### Using an IDE
1. Open the entire `01-java` directory in your IDE
2. Navigate to the specific exercise
3. Right-click on the `.java` file and select "Run" or "Debug"

## Learning Objectives

These exercises cover fundamental Java concepts:

- **Basic Syntax**: Variables, data types, operators
- **Control Flow**: If-else statements, switch cases, loops
- **Methods**: Function definition and usage
- **Arrays and Collections**: Data structure manipulation
...
- All package names follow lowercase convention to match directory structure
...
- Some exercises may require user input via console

## Common Issues

### Compilation Errors
- Ensure package name matches directory structure
...
- Learning about Java concurrency
- Studying design patterns in Java

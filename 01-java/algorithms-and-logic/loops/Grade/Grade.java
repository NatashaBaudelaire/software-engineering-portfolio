    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (grade1 < 0 || grade1 > 10) {
                System.out.print("Invalid grade! Enter a value between 0 and 10.");
            }
        ...
        do {
            ...
            if (input.hasNextInt()) {
                ...
                if (missedClasses >= 0) {
                    ...
                    System.out.print("Invalid! Please enter a valid number of absences.");
                }
            } else {
        ...
        double absencePercentage = (missedClasses / totalClasses) * 100;


        String status = (average >= 6 && absencePercentage <= 25)
                ? "Approved"
                : "Failed";
